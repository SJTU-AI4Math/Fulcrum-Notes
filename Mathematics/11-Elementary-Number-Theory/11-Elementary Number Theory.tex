    ...
    \section{二次剩余}
        \subsection{二次剩余与欧拉判别准则}
            \begin{dfn}
                ...
                [Quadratic Residue]
                [白菜]
                设\(p:\mathbb{Z}\)为奇素数, \(a:\mathbb{Z}\), 且 \(\gcd(a,p)=1\). 若同余方程
                \[
                    x^2 \equiv a \mod{p}
                \]
            ...
            \begin{thm}
                ...
                [Euler's Criterion]
                [白菜]
                设\(p:\mathbb{Z}\)为奇素数, \(a:\mathbb{Z}\), 且 \(\gcd(a,p)=1\). 则
                \[
            ...
            \begin{crl}
                ...
                []
                [白菜]
                设\(p:\mathbb{Z}\)为奇素数, 则模 \(p\) 的二次剩余共有 \(\frac{p-1}{2}\) 个. 
        ...
        \subsection{勒让德符号}
            \begin{dfn}
                ...
                [Legendre Symbol]
                [白菜]
                设\(p:\mathbb{Z}\)为奇素数, \(a:\mathbb{Z}\). 则勒让德符号定义为
                \[
                    \left( \frac{a}{p} \right) =
                    \begin{cases}
                        0 & \text{若 } p \mid a\\
            ...
            \begin{ppt}
                ...
                []
                [白菜]
                设\(p:\mathbb{Z}\)为奇素数, \(a:\mathbb{Z}\). 则有
                \[
            ...
            \begin{ppt}
                ...
                []
                [白菜]
                设\(p:\mathbb{Z}\)为奇素数, \(a,b:\mathbb{Z}\). 则有
                \[
        ...
        \subsection{Gauss引理与二次互反律}
            \begin{thm}
                ...
                [Gauss' Lemma]
                [白菜]
                设\(p:\mathbb{Z}\)为奇素数, \(a:\mathbb{Z}\), 且 \(\gcd(a,p)=1\). 记集合
                \[
            ...
            \begin{lma}
                ...
                []
                [白菜] 
                设\(p:\mathbb{Z}\)为奇素数. \(\gcd(p,2a)=1\), 记集合
                \[
                    S = \{a, 2a, 3a, \ldots, \frac{p-1}{2} a\}
                \]
                中模 \(p\) 意义下的最小正剩余中大于 \(\frac{p}{2}\) 的元素个数为 \(n\). 则有
        ...
        \subsection{Jacobi符号}
            \begin{dfn}
                ...
                [Jacobi Symbol]
                [白菜]
                设\(n:\mathbb{Z}\)为奇正整数, 且 \(n=p_1^{e_1} p_2^{e_2} \cdots p_k^{e_k}\)为其素因子分解. 
                对于任意\(a:\mathbb{Z}\), 定义Jacobi符号为
                \[
            ...
            \begin{ppt}
                ...
                []
                [白菜]
                设\(n, n_1,n_2:\mathbb{Z}\)为奇正整数, \(a,b:\mathbb{Z}\). 则有
                \[
