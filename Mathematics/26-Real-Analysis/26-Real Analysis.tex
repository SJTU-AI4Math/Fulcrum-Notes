...
\begin{document}
    ...
    \section{Lebesgue 测度} % uuid:"05RA.Cat.Section.LebesgueMeasure"

        \subsection{\(\sigma\)-代数与测度空间} % uuid:"05RA.Cat.Subsection.SigmaAlgebraMeasureSpace"

            \begin{dfn}
                [05RA.Cat.SigmaAlgebra]
                {\(\sigma\)-代数}
                [\(\sigma\)-Algebra]
                [猫猫]
            ...
            \begin{ppt}
                [05RA.Cat.SinglePointZeroMeasure]
                {单点集零测}
                []
                [猫猫]
        ...
        \subsection{\(\R\) 上的 Lebesgue 测度} % uuid:"05RA.Cat.Subsection.LebesgueMeasureOnR"
        
            \begin{dfn}
                [05RA.Cat.CompleteMeasureSpace]
                {完备测度空间}
            ...
            \begin{dfn}
                [05RA.Cat.InnerOuterLebesgueMeasure]
                {Lebesgue 内/外测度}
            ...
            \begin{dfn}
                [05RA.Cat.LebesgueMeasurableSet]
                {Lebesgue 可测集}
            ...
            \begin{ppt}
                [05RA.Cat.ConstantinCaratheodory]
            ...
            \begin{ppt}
                [05RA.Cat.OuterMeasureZeroMeasurable]
            ...
            \begin{thm}
                [05RA.Cat.LebesgueMeasurableSetSigmaAlgebra]
            ...
            \begin{crl}
                [05RA.Cat.LebesgueMeasurableSetGeneratedByBorelZero]
            ...
            \begin{ppt}
                [05RA.Cat.BorelMeasureIsLebesgueMeasureOnBorel]
            ...
            \begin{ppt}
                [05RA.Cat.LebesgueMeasureComplete]
                {Lebesgue 测度完备}
                []
                [猫猫]
            \end{ppt}
            ...
            \begin{ppt}
                [05RA.Cat.LebesgueMeasureTranslationInvariant]
                {Lebesgue 测度平移不变}
                []
                [猫猫]
            \end{ppt}
            ...
            \begin{thm}
                [05RA.Cat.LittlewoodFirstPrinciple]
                {Littlewood 第一原理}
                []
                [猫猫]
                有限测度的可测集接近于区间的有限并: 
    ...
    \section{Lebesgue 可测函数} % uuid:"05RA.Cat.Section.LebesgueMeasurableFunction"
        ...
        *称一个性质``几乎处处''成立指该性质在除了某零测集外处处成立. 
        ...
        \subsection{Lebesgue 可测函数} % uuid:"05RA.Cat.Subsection.LebesgueMeasurableFunction"

            \begin{dfn}
                [05RA.Cat.LebesgueMeasurableFunction]
                {Lebesgue 可测函数}
            ...
            \begin{ppt}
                [05RA.Cat.LebesgueMeasurableFunctionEquivDef]
                {Lebesgue 可测函数的等价定义}
                []
                [猫猫]
                设 \(S\) 是可测集, 则下列叙述互相等价: 
            ...
            \begin{ppt}
                [05RA.Cat.LebesgueMeasurableFunctionSinglePreimageMeasurable]
                {可测函数单点值的原像可测}
                []
                [猫猫]
            ...
            \begin{ppt}
                [05RA.Cat.LebesgueMeasurableFunctionOpenPreimageMeasurable]
                {函数可测当且仅当开集的原像可测}
                []
                [猫猫]
            ...
            \begin{ppt}
                [05RA.Cat.LebesgueMeasurableFunctionCombination]
                {可测函数的拼合}
                []
                [猫猫]
            ...
            \begin{ppt}
                [05RA.Cat.LebesgueMeasurableFunctionTransitivity]
                {可测函数的传递性}
                []
                [猫猫]
            ...
            \begin{ppt}
                [05RA.Cat.LebesgueMeasurableFunctionAlgebra]
                {可测函数代数}
                []
                [猫猫]
            ...
            \begin{ppt}
                [05RA.Cat.LebesgueMeasurableFunctionComposition]
                {可测函数的复合稳定性}
                []
                [猫猫]
            \end{ppt}
            ...
            \begin{ppt}
                [05RA.Cat.LebesgueMeasurableFunctionPointwiseLimit]
                {可测函数的逐点收敛稳定性}
                []
                [猫猫]
            ...
            \begin{xmp}
                [05RA.Cat.ContinuousFunctionMeasurable]
                {可测集定义域上的连续实值函数可测}
                []
                [猫猫]
            \end{xmp}
            ...
            \begin{xmp}
                [05RA.Cat.MonotoneFunctionMeasurable]
                {定义在区间上的单调函数可测}
                []
                [猫猫]
            \end{xmp}
        ...
        \subsection{简单逼近定理} % uuid:"05RA.Cat.Subsection.SimpleFunctionApproximationTheorem"
            
            \begin{dfn}
                [05RA.Cat.IndicatorFunction]
                {指示/示性/特征函数}
            ...
            \begin{ppt}
                [05RA.Cat.MeasurableSetIndicatorFunction]
                {集合可测当且仅当其指示函数可测}
                []
                [猫猫]
            \end{ppt}
            ...
            \begin{ppt}
                [05RA.Cat.SimpleFunctionAlgebra]
                {简单函数代数}
            ...
            \begin{ppt}
                [05RA.Cat.SimpleFunctionCanonicalRepresentation]
                {简单函数的典范表示}
                []
                [猫猫]
            ...
            \begin{lma}
                [05RA.Cat.SimpleFunctionApproximationLemma]
                {简单逼近引理}
            ...
            \begin{thm}
                [05RA.Cat.SimpleFunctionApproximationTheorem]
                {简单逼近定理}
        ...
        \subsection{Littlewood 原理} % uuid: "05RA.Cat.Subsection.LittlewoodsPrinciples"

            \begin{lma}
                [05RA.Cat.EgoroffsLemma]
                {Egoroff 引理}
                [Egoroff's Lemma]
                [猫猫]
            ...
            \begin{lma}
                [05RA.Cat.LittlewoodsSecondPrinciple]
                {Littlewood 第二原理}
    ...
    \section{Lebesgue 积分} % uuid:"05RA.Cat.Section.LebesgueIntegral"

        \subsection{有限测度集上有界可测函数的 Lebesgue 积分}
            
            \begin{dfn}
                [05RA.Cat.SimpleLebesgueIntegral]
                {简单函数的 Lebesgue 积分}
