    ...
    \subsection{Riemann映照定理与边界表现}
        ...
        \begin{xmp}
            ...
            \begin{enumerate}
                ...
                \item 将扇形 \(0\leq\arg z\leq \alpha\) 映到上半平面 \(\mathbb{H}\) 的幂函数: \[w=z^{\pi/\alpha}\]
                \item 将水平条 \(\{z:a<\Im z<b\}\) 映到上半平面 \(\mathbb{H}\) 的指数函数: \[w=\exp\frac{\pi}{b-a}z\]
                \item 将上半平面 \(\mathbb{H}\) 映到水平条 \(\{z:a<\Im z<b\}\) 的对数函数: \[w=\frac{b-a}{\pi}\ln z\]
                \item 将半无穷条带 \(0\leq\Re z\leq\pi,\Im z>0\) 映到上半平面 \(\mathbb{H}\) 的三角函数: \[w=\sin z, w=\cos z, w=\sinh z, w=\cosh z\] 具体使用哪个要视情况而定.
