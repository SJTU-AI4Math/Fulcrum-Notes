        ...
        \subsection{卷积及其应用}
            ...
            \begin{ppt}
                ...
                \begin{enumerate}
                    ...
                    \item 支撑集可加性: 设 $supp f\subseteq [a,b], \supp g\subseteq [c,d]$, 则 $\supp(f\ast g)\subseteq [a+c,b+d]$;
            ...
            \begin{dfn}
                ...
                \begin{enumerate}
                    ...
                    \item 0处有支撑: 对于 $x=0$ 的任意邻域 $U(0)$: \[\lim_{n\to\infty}\int_{U(0)}f_n(x)\dd{x}=1.\]
                \end{enumerate}
            \end{dfn}
            \begin{dfn}
                [Delta-Approx]
                ...
                \begin{enumerate}
                    ...
                    \item 0处有支撑: 对于 $x=0$ 的任意邻域 $U(0)$: \[\lim_{\epsilon\to\epsilon_0}\int_{U(0)}f_n(x)\dd{x}=1.\]
                \end{enumerate}
            \end{dfn}
            \begin{xmp}
                [Gauss-Kernel]
